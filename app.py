        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    ...
                    dcc.Dropdown(
                        id="region",
                        options=[{"label": "Ganz Deutschland", "value": 0}] +
                    ...
                    dcc.Slider(id="population",min=0,max=20000,step=5000,value=5000),

                    html.Br(),
                    html.Label("I₀"),
                    dcc.Slider(id="I0",min=0,max=100,step=5,value=10),
...
def update_simulation(region_id,start,end,model_type,N,I0,split_ratio,fit_mode):
    ...
    if region_id == 0:
        ...
        df_region = df[df["IdLandkreis"]==region_id]
        df_period = df_region[(df_region["Meldedatum"]>=start)&(df_region["Meldedatum"]<=end)]
